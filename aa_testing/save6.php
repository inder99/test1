...
*/
	if(!isset($message)) {
		...
		$query = "SELECT * FROM test2 where stu_email = '" . $_POST["stu_email"] . "'";
		$count = $db_handle->numRows($query);
		
		if($count==0) {
			$query = "INSERT INTO test2 (stu_email, stu_password,first_name, last_name,father_name,mother_name,dob, gender,mobile,rollno,course,branch,semester,dept,cgpa,be_pass_year,twelveth_marks,twelveth_year,tenth_marks,tenth_year) VALUES
			('" . $_POST["stu_email"] . "', '" . md5($_POST["stu_password"]) . "','" . $_POST["first_name"] . "', '" . $_POST["last_name"] . "', '" . $_POST["father_name"] . "',  '" . $_POST["mother_name"] . "','" . $_POST["dob"] . "', '" . $_POST["gender"] . "', '" . $_POST["mobile"] . "', '" . $_POST["rollno"] . "','" . $_POST["course"] . "', '" . $_POST["branch"] . "','" . $_POST["semester"] . "', '" . $_POST["dept"] . "', '" . $_POST["cgpa"] . "', '" . $_POST["be_pass_year"] . "', '" . $_POST["twelveth_marks"] . "', '" . $_POST["twelveth_year"] . "', '" . $_POST["tenth_marks"] . "', '" . $_POST["tenth_year"] . "')";
