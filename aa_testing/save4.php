...
*/
	if(!isset($message)) {
		...
		$query = "SELECT * FROM registered_users1 where stu_email = '" . $_POST["stu_email"] . "'";
		$count = $db_handle->numRows($query);
		
		if($count==0) {
			$query = "INSERT INTO registered_users1 (stu_email, stu_password, first_name, last_name, father_name, mother_name,dob, gender,mobile) VALUES
			('" . $_POST["stu_email"] . "', '" . md5($_POST["stu_password"]) . "','" . $_POST["first_name"] . "', '" . $_POST["last_name"] . "', '" . $_POST["father_name"] . "',  '" . $_POST["mother_name"] . "','" . $_POST["dob"] . "', '" . $_POST["gender"] . "', '" . $_POST["mobile"] . "')";
